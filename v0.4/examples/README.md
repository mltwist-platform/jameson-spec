# JAMESON v0.4 Examples

Complete, conformant JAMESON documents covering the major labeling scenarios. Section references (§) point into the [v0.4 specification](../README.md).
